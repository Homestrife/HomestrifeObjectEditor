...
//            eventHoldPane.add(airStunInterface);
    ...
    public void applyChanges()
    {
        ...
        if(hsObject.IsFighter())
        {
            ((FighterObject)hsObject).fighterEventHolds.standing = standing.getSelectedIndex() == 0 ? null : (FighterHold)standing.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.turn = turn.getSelectedIndex() == 0 ? null : (FighterHold)turn.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.walk = walk.getSelectedIndex() == 0 ? null : (FighterHold)walk.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.walking = walking.getSelectedIndex() == 0 ? null : (FighterHold)walking.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.walkingTurn = walkingTurn.getSelectedIndex() == 0 ? null : (FighterHold)walkingTurn.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.run = run.getSelectedIndex() == 0 ? null : (FighterHold)run.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.running = running.getSelectedIndex() == 0 ? null : (FighterHold)running.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.runningTurn = runningTurn.getSelectedIndex() == 0 ? null : (FighterHold)runningTurn.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.runningStop = runningStop.getSelectedIndex() == 0 ? null : (FighterHold)runningStop.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.crouch = crouch.getSelectedIndex() == 0 ? null : (FighterHold)crouch.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.crouching = crouching.getSelectedIndex() == 0 ? null : (FighterHold)crouching.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.crouchingTurn = crouchingTurn.getSelectedIndex() == 0 ? null : (FighterHold)crouchingTurn.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.stand = stand.getSelectedIndex() == 0 ? null : (FighterHold)stand.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.jumpNeutralStart = jumpNeutralStart.getSelectedIndex() == 0 ? null : (FighterHold)jumpNeutralStart.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.jumpNeutralStartAir = jumpNeutralStartAir.getSelectedIndex() == 0 ? null : (FighterHold)jumpNeutralStartAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.jumpNeutralRising = jumpNeutralRising.getSelectedIndex() == 0 ? null : (FighterHold)jumpNeutralRising.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.jumpNeutralFall = jumpNeutralFall.getSelectedIndex() == 0 ? null : (FighterHold)jumpNeutralFall.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.jumpNeutralFalling = jumpNeutralFalling.getSelectedIndex() == 0 ? null : (FighterHold)jumpNeutralFalling.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.jumpNeutralLand = jumpNeutralLand.getSelectedIndex() == 0 ? null : (FighterHold)jumpNeutralLand.getSelectedItem();
...
//            ((Fighter)hsObject).fighterEventHolds.jumpBackwardStart = jumpBackwardStart.getSelectedIndex() == 0 ? null : (FighterHold)jumpBackwardStart.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.jumpBackwardRising = jumpBackwardRising.getSelectedIndex() == 0 ? null : (FighterHold)jumpBackwardRising.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.jumpBackwardFall = jumpBackwardFall.getSelectedIndex() == 0 ? null : (FighterHold)jumpBackwardFall.getSelectedItem();
...
//            ((Fighter)hsObject).fighterEventHolds.jumpBackwardLandHard = jumpBackwardLandHard.getSelectedIndex() == 0 ? null : (FighterHold)jumpBackwardLandHard.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.airDashForward = airDashForward.getSelectedIndex() == 0 ? null : (FighterHold)airDashForward.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.airDashBackward = airDashBackward.getSelectedIndex() == 0 ? null : (FighterHold)airDashBackward.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.blockHigh = blockHigh.getSelectedIndex() == 0 ? null : (FighterHold)blockHigh.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.blockLow = blockLow.getSelectedIndex() == 0 ? null : (FighterHold)blockLow.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.blockAir = blockAir.getSelectedIndex() == 0 ? null : (FighterHold)blockAir.getSelectedItem();
...
//            ((Fighter)hsObject).fighterEventHolds.hitstunHighStandingStart = hitstunHighStandingStart.getSelectedIndex() == 0 ? null : (FighterHold)hitstunHighStandingStart.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.hitstunLightHighStanding = hitstunLightHighStanding.getSelectedIndex() == 0 ? null : (FighterHold)hitstunLightHighStanding.getSelectedItem();
//            ((Fighter)hsObject).fighterEventHolds.hitstunHighStandingEnd = hitstunHighStandingEnd.getSelectedIndex() == 0 ? null : (FighterHold)hitstunHighStandingEnd.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.hitstunLightMidStanding = hitstunLightMidStanding.getSelectedIndex() == 0 ? null : (FighterHold)hitstunLightMidStanding.getSelectedItem();
//            ((Fighter)hsObject).fighterEventHolds.hitstunLowStandingStart = hitstunLowStandingStart.getSelectedIndex() == 0 ? null : (FighterHold)hitstunLowStandingStart.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.hitstunLightLowStanding = hitstunLightLowStanding.getSelectedIndex() == 0 ? null : (FighterHold)hitstunLightLowStanding.getSelectedItem();
...
//            ((Fighter)hsObject).fighterEventHolds.hitstunCrouchingStart = hitstunCrouchingStart.getSelectedIndex() == 0 ? null : (FighterHold)hitstunCrouchingStart.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.hitstunLightMidCrouching = hitstunLightMidCrouching.getSelectedIndex() == 0 ? null : (FighterHold)hitstunLightMidCrouching.getSelectedItem();
//            ((Fighter)hsObject).fighterEventHolds.hitstunCrouchingEnd = hitstunCrouchingEnd.getSelectedIndex() == 0 ? null : (FighterHold)hitstunCrouchingEnd.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.hitstunLightLowCrouching = hitstunLightLowCrouching.getSelectedIndex() == 0 ? null : (FighterHold)hitstunLightLowCrouching.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.hitstunLightAir = hitstunLightAir.getSelectedIndex() == 0 ? null : (FighterHold)hitstunLightAir.getSelectedItem();
...
//            ((Fighter)hsObject).fighterEventHolds.airbornFaceSideMoveForward = airbornFaceSideMoveForward.getSelectedIndex() == 0 ? null : (FighterHold)airbornFaceSideMoveForward.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightNeutralGround = attackLightNeutralGround.getSelectedIndex() == 0 ? null : (FighterHold)attackLightNeutralGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightDownGround = attackLightDownGround.getSelectedIndex() == 0 ? null : (FighterHold)attackLightDownGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightUpGround = attackLightUpGround.getSelectedIndex() == 0 ? null : (FighterHold)attackLightUpGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightForwardGround = attackLightForwardGround.getSelectedIndex() == 0 ? null : (FighterHold)attackLightForwardGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightQCFGround = attackLightQCFGround.getSelectedIndex() == 0 ? null : (FighterHold)attackLightQCFGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightNeutralAir = attackLightNeutralAir.getSelectedIndex() == 0 ? null : (FighterHold)attackLightNeutralAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightDownAir = attackLightDownAir.getSelectedIndex() == 0 ? null : (FighterHold)attackLightDownAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightUpAir = attackLightUpAir.getSelectedIndex() == 0 ? null : (FighterHold)attackLightUpAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightForwardAir = attackLightForwardAir.getSelectedIndex() == 0 ? null : (FighterHold)attackLightForwardAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightBackwardAir = attackLightBackwardAir.getSelectedIndex() == 0 ? null : (FighterHold)attackLightBackwardAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackLightQCFAir = attackLightQCFAir.getSelectedIndex() == 0 ? null : (FighterHold)attackLightQCFAir.getSelectedItem();
            
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyNeutralGround = attackHeavyNeutralGround.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyNeutralGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyDownGround = attackHeavyDownGround.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyDownGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyUpGround = attackHeavyUpGround.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyUpGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyForwardGround = attackHeavyForwardGround.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyForwardGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyQCFGround = attackHeavyQCFGround.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyQCFGround.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyNeutralAir = attackHeavyNeutralAir.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyNeutralAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyDownAir = attackHeavyDownAir.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyDownAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyUpAir = attackHeavyUpAir.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyUpAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyForwardAir = attackHeavyForwardAir.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyForwardAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyBackwardAir = attackHeavyBackwardAir.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyBackwardAir.getSelectedItem();
            ((FighterObject)hsObject).fighterEventHolds.attackHeavyQCFAir = attackHeavyQCFAir.getSelectedIndex() == 0 ? null : (FighterHold)attackHeavyQCFAir.getSelectedItem();
            
            ((FighterObject)hsObject).fighterEventHolds.knockout = knockout.getSelectedIndex() == 0 ? null : (FighterHold)knockout.getSelectedItem();
        }
